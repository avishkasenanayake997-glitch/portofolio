...
const socials = [
  { icon: GithubIcon, href: "https://github.com/avishkasenanayake997-glitch", label: "GitHub", color: "hover:text-white hover:bg-gray-700/50" },
  { icon: Globe, href: "https://www.linkedin.com", label: "LinkedIn", color: "hover:text-blue-300 hover:bg-blue-500/20" },
  { icon: AtSign, href: "mailto:Avishkasenanayake997@gmail.com", label: "Email", color: "hover:text-sky-300 hover:bg-sky-500/20" },
];
